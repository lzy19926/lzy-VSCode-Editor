...
var AMDLoader;
//! -------定义多个loader相关类 统一挂载到AMDLoader上

//!----- 01 用于环境判断的类  通过_detect方法进行统一环境检查
(function (AMDLoader) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
//!----- 02 定义LoaderEvent类, 用于记录模块加载事件,
//! 创建E对象用于发送到服务器   推送对应的事件对象到_event中
var AMDLoader;
(function (AMDLoader) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
//!----- 03 工具函数类Utilities 提供各种全局工具函数如
//! fileUriToFilePath  startsWith  endsWith  containsQueryString 等
var AMDLoader;
(function (AMDLoader) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
//!------04  配置对象Configuration 用于单独管理和创建插件配置
var AMDLoader;
(function (AMDLoader) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
//!------05 ModuleManager 用于管理和加载 JavaScript 模块

//! 具有下列模块
//todo Module 模块对象等等
//todo ModuleIdResolver 用于单独解析模块ID 标准化, (就是一个resolver)
