...
let Workbench = exports.Workbench = class Workbench {
    parts = new Map();
    constructor(editorPart, titleBarPart, sideBarPart, terminalPart, fileTabPart, broswerEventsService) {
...
exports.Workbench = Workbench = __decorate([
    ...
    __param(1, TitleBar_1.ITitleBarPart),
    __param(2, SideBar_1.ISideBarPart),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.IEditorPart = exports.EditorPart = void 0;
...
exports.IEditorPart = (0, decorator_1.createDecorator)("IEditorPart");
(0, serviceCollection_1.registerSingleton)(exports.IEditorPart, EditorPart);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ICommandService = void 0;
/*
 * @Author: Luzy
...
class CommandService {
    executeCommand(id, ...args) {
        const command = CommandsRegistry_1.CommandsRegistry.getCommand(id);
        if (!command) {
...
exports.ICommandService = (0, decorator_1.createDecorator)("ICommandService");
(0, serviceCollection_1.registerSingleton)(exports.ICommandService, CommandService);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ISideBarPart = exports.SideBarPart = void 0;
/*
 * @Author: Luzy
 * @Date: 2023-08-22 11:36:46
 * @LastEditors: Luzy
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ITitleBarPart = exports.TitleBarPart = void 0;
/*
 * @Author: Luzy
 * @Date: 2023-08-22 11:36:46
 * @LastEditors: Luzy
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ITerminalPart = exports.TerminalPart = void 0;
/*
 * @Author: Luzy
 * @Date: 2023-08-22 11:36:46
 * @LastEditors: Luzy
...
const serviceCollection_1 = __webpack_require__(4);
const IPCRendererService_1 = __webpack_require__(8);
const xterm_addon_attach_1 = __webpack_require__(19);
const xterm_addon_fit_1 = __webpack_require__(20);
const xterm_1 = __webpack_require__(21);
...
exports.TerminalPart = TerminalPart = __decorate([
    __param(0, IPCRendererService_1.IIPCRendererService)
], TerminalPart);
